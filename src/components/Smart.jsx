  ...
  return (
    <div className="smart-fridges">
      ...
      <div className="container-fluid py-4 bg-light">
        <div className="row align-items-center">
          <div className="col-md-6 text-center">
            <img src="/image/image21.png" alt="Fridge Safety" className="img-fluid fridge-image" />
          </div>
      ...
      <div className="container-fluid bg-custom py-4">
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-md-6 text-center">
              <img src="/image/image18.png" alt="Stocking Algorithm" className="img-fluid fridge-image" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container-fluid py-4 bg-light">
        <div className="row align-items-center">
          <div className="col-md-6 text-center">
            <img src="/image/image23.png" alt="Fridge Safety" className="img-fluid fridge-image" />
          </div>
          <div className="col-md-3">
