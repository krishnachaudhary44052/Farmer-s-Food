    ...
    return (
        <div className="position-relative  z-3">
            ...
            <header className="main_header shadow-sm py-3 px-3 position-relative">
                <div className="container d-flex justify-content-between align-items-center">
                    ...
                    <div className="d-flex align-items-center">
                        <div className="fs-3 fw-bold text-dark">
                            <Link to="/" className="text-decoration-none text-primary1">DietIn</Link><span className="text-info">.</span>
                        </div>
                    </div>

                    {/* Desktop Nav */}
                    <nav className="d-none d-md-flex align-items-center gap-4">
                        <Link to="/Menu" className=" text-black text-decoration-none pb-1">Menu</Link>
                        <div
                            className="position-relative"
                            onMouseEnter={() => setShowMealPlan(true)}
                            onMouseLeave={() => setShowMealPlan(false)}
                        >
                            <button className="btn btn-link text-black p-0 d-flex text-decoration-none align-items-center">
                                About us
                ...
                {/* Mobile Dropdown */}
                {mobileMenuOpen && (
                    <div className="d-md-none mt-3 bg-black border-top border-secondary  position-absolute top-100 start-0 w-100 z-3 p-3 shadow">
