      ...
      <div className="container">
        ...
        <div className="row align-items-center mb-5">
          <div className="col-md-6 text-center">
            <img src="/image/05.jpg"  style={{width:"420px"}} alt="It All Started" className="img-fluid rounded shadow" />
          </div>
          <div className="col-md-6">
        ...
        <div className="row align-items-center mb-5 flex-md-row-reverse">
          <div className="col-md-6 text-center">
            <img src="/image/06.jpg" style={{width:"420px"}} alt="Our Mission" className="img-fluid rounded shadow" />
          </div>
          <div className="col-md-6">
        ...
        <div className="row align-items-center">
          <div className="col-md-6 text-center">
            <img src="/image/image19.png"  style={{width:"420px"}} alt="All About the Food" className="img-fluid rounded shadow" />
          </div>
          <div className="col-md-6">
